    ...
    override func viewDidLoad() {
        ...
        (data, response, error) in
            ...
            if error != nil {
                ...
                var fetch = NSFetchRequest(entityName: "BlogItems")
                ...
                let itemsResult = jsonResult["items"] as NSArray
                ...
                for i in 0..<itemsResult.count {
                    ...
                    var item = itemsResult[i] as NSDictionary
                    var authorDict = item["author"] as NSDictionary

                    newBlogItem.setValue(authorDict["displayName"] as NSString, forKey: "author")
...
//                fetch = NSFetchRequest(entityName: "BlogItems")
//                fetch.returnsObjectsAsFaults = false
